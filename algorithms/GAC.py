...
f.write(f'{iname},GAC,{cs},{running_time},{u["optimality_gap"]},{u["0no"]},{u["3no"]},{u["TTS"]}\n')
f.close()

f = open(f'results/findgap_results_GAC/{iname}.csv', 'w', encoding='utf-8')
