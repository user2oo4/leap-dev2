...
fig.update_layout(
    xaxis_title = "Deg",
    yaxis_title = "Solutions within 3\% (Relative to DWave default)",
...
if not os.path.exists("images"):
    os.mkdir("images")
fig.write_image("images/fig_3no_rel_deg.png")
fig.show()
...
fig.update_layout(
    xaxis_title = "Deg",
    yaxis_title = "Solutions within 3\%",
    xaxis_showgrid = False,
    yaxis_showgrid = False,
    width = 1250,
    height = 700,
...
if not os.path.exists("images"):
    os.mkdir("images")
fig.write_image("images/fig_3no_abs_deg.png")
