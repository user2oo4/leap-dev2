...
for i in tmp3['chain_strength']:
    rel3.insert(len(rel3), i)
for i in tmp4['chain_strength']:
    rel4.insert(len(rel4), i)
for i in tmp5['chain_strength']:
    rel5.insert(len(rel5), i)
for i in tmp6['chain_strength']:
    rel6.insert(len(rel6), i)
for i in tmp7['chain_strength']:
...
fig.update_layout(
    xaxis_title = "Deg",
    yaxis_title = "Chain Strength (Relative to DWave default)",
...
if not os.path.exists("images"):
    os.mkdir("images")
fig.write_image("images/fig_chain_strength_rel_deg.png")
fig.show()
...
if not os.path.exists("images"):
    os.mkdir("images")
fig.write_image("images/fig_chain_strength_abs_deg.png")
fig.show()
