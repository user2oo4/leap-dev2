...
fig.update_layout(
    xaxis_title = "Deg",
    yaxis_title = "Average time to find optimal solution (relative to DWave)",
...
fig.update_layout(
    xaxis_title = "Deg",
    yaxis_title = "Average time to find optimal solution",
    xaxis_showgrid = False,
    yaxis_showgrid = False,
    width = 1250,
    height = 700,
